...
switch (_shop) do
{
	case "market": {["Markt",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","vitem_repairkit","vitem_firstaidkit","box","bread"]]};
	...
	case "wongs": {["City Wok",["turtlesoup","turtle","froglegs"]]};
	case "turtledealer": {["Delikatessen",["turtlesoup","turtle","froglegs"]]};
	...
	case "bier": {["Bierhändler",[/*"coal",*/"bier","bread"]]}; //##10
	case "bread": {["Brothändler",[/*"coal",*/"bread"]]}; //##10
