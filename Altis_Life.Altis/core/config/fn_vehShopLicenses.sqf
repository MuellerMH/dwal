...
switch (life_veh_shop) do
{
	...
	case "cop_air_4": {_ret = license_cop_air;};
	case "cop_air_5": {_ret = license_cop_air;};
	case "cop_air_6": {_ret = license_cop_air;};
	case "cop_air_7": {_ret = license_cop_air;};
	case "cop_air_8": {_ret = license_cop_air;};
	case "cop_air_9": {_ret = license_cop_air;};
	case "cop_air_10": {_ret = license_cop_air;};
	...
	case "reb_v_1_3": {_ret = license_civ_rebel;};
