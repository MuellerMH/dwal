...
switch(life_veh_shop) do
{
	...
	{
		//if(!license_civ_boat) exitWith {_kill = true;};
		_sp = getMarkerPos "civ_ship_11";
		_dir = markerDir "civ_ship_11";	
	...
	case "cop_air_6":
	{
		_sp = getMarkerPos "cop_air_6";
		_dir = markerDir "cop_air_6";
	...
	case "cop_air_7":
	{
		_sp = getMarkerPos "cop_air_7_1";
		_dir = markerDir "cop_air_7_1";
	...
	case "cop_air_8":
	{
		_sp = getMarkerPos "cop_air_8";
		_dir = markerDir "cop_air_8";
	...
	case "cop_air_10":
	{
		_sp = getMarkerPos "cop_air_10";
		_dir = markerDir "cop_air_10";
	...
	case "reb_v_1_3":
	{
		_sp = getMarkerPos "reb_v_1_3";
		_dir = markerDir "reb_v_1_3";
	...
	case "reb_v_3":
	{
		_sp = getMarkerPos "reb_v_3";
		_dir = markerDir "reb_v_3";
	...
	case "cop_ship_3":
	{
		_sp = getMarkerPos "cop_ship_3";
		_dir = markerDir "cop_ship_3";
...
{	
	...
	
	{
		...
		{
			_price = (_x select 2);
			systemChat format ["Price found: %1", [round(_price * 0.65)] call life_fnc_numberText ];
		};
	}
