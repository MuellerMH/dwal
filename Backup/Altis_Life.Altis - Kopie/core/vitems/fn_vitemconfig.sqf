...
life_vitems = [
	...
	["launch_NLAW_F", "nlaw_f", "PCML (Eingepackt)", 60, true, -1, -1, 0],
	["launch_RPG32_F", "rpg32_f", "RPG-42 Alamut (Eingepackt)", 60, true, -1, -1, 0],
	...
	["arifle_Mk20C_F", "mk20c", "Mk20C 5.56 mm (Eingepackt)", 30, true, -1, -1, 25000],
	["arifle_MXM_F", "mxm", "MXM 6.5 mm (Eingepackt)", 30, true, -1, -1, 25000],
	["arifle_MXC_Holo_F", "mxc", "MXM 6.5 mm Holo (Eingepackt)", 30, true, -1, -1, 25000],
	["arifle_MXC_Holo_pointer_F", "mxcp", "MXM 6.5 mm Holo Pointer (Eingepackt)", 30, true, -1, -1, 25000],
	["arifle_MX_F", "mx", "MX 6.5 mm (Eingepackt)", 30, true, -1, -1, 25000],
	["srifle_LRR_LRPS_F", "lrr", "M320 LRR .408 (Eingepackt)", 30, true, -1, -1, 25000],
	["srifle_GM6_F", "lynx", "GM6 Lynx 12.7 mm (Eingepackt)", 30, true, -1, -1, 25000],
	["srifle_GM6_SOS_F", "lynxsos", "GM6 Lynx (SOS) 12.7 mm (Eingepackt)", 30, true, -1, -1, 25000],
