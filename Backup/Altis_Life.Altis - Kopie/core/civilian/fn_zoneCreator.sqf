...
_hopsZones = ["Hopfen_swamp1"];
_cerealsZones = ["Getreide_swamp1"];
_yeastZones = ["Hefe_swamp1"];
...
//Create frog zones
{
	...
	_zone setTriggerArea[50,50,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Hops = player addAction['Hopfen ernten',life_fnc_gatherHops,'',6,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Hops;"];
} foreach _hopsZones;
...
//Create frog zones
{
	...
	_zone setTriggerArea[50,50,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Cereals = player addAction['Getreide ernten',life_fnc_gatherCereals,'',6,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Cereals;"];
...
//Create frog zones
{
	...
	_zone setTriggerArea[50,50,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Yeast = player addAction['Hefe ernten',life_fnc_gatherYeast,'',6,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Yeast;"];
} foreach _yeastZones;