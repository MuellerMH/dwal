...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_Marshal","Marshal Outfit",1550],
			["U_C_Driver_1","Fuel Outfit",5000],
			["U_C_Driver_2","Bluking Outfit",5000],
			["U_C_Driver_3","Redstone Outfit",5000],
			["U_C_Driver_4","Vrana Outfit",5000]
		];
	};
