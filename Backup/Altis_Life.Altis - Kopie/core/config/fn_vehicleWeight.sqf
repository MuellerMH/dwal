...
/*switch ((typeOf _vehicle)) do
{
	...
	case "C_Van_01_box_F": {_weight = 230;};
	case "I_Truck_02_transport_F": {_weight = 300;};
	case "I_Truck_02_covered_F": {_weight = 350;};
	case "B_Truck_01_transport_F": {_weight = 350;};
	case "O_Truck_03_transport_F": {_weight = 350;};
	case "B_Truck_01_covered_F": {_weight = 500;};
	case "O_Truck_03_covered_F": {_weight = 500;};
	case "O_G_Van_01_fuel_F": {_weight = 180;};
	case "I_MRAP_03_F": {_weight = 100;};
	case "B_MRAP_01_F": {_weight = 100;};
	case "O_MRAP_02_F": {_weight = 150;};
	case "B_MRAP_01_hmg_F": {_weight = 100;};
	case "C_Rubberboat": {_weight = 50;};
	case "C_Boat_Civil_01_F": {_weight = 100;};
	case "B_Truck_01_box_F": {_weight = 850;};
	case "B_Truck_01_fuel_F": {_weight = 200;};
	case "B_Boat_Transport_01_F": {_weight = 50;};
	case "O_Truck_03_medical_F": {_weight = 650;};
	case "I_MRAP_03_F": {_weight = 50;};
