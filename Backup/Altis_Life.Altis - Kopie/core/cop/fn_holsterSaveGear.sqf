...
{
	{
		_primaryWeaponMagazine set[count _magazines,_x];
...
{
	{
		_primaryWeaponItems set[count _magazines,_x];
...
{
	{
		_secondaryWeaponMagazine set[count _magazines,_x];
...
{
	{
		_secondaryWeaponItems set[count _magazines,_x];
...
{
	{
		_handgunItems set[count _magazines,_x];
