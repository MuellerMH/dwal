...
life_radio_west = radioChannelCreate [[0, 0.95, 1, 0.8], "Polizei Channel", "(Polizei) %UNIT_NAME", []];
life_radio_civ = radioChannelCreate [[0, 0.95, 1, 0.8], "Zivilisten Channel", "(Zivilist) %UNIT_NAME", []];
...
publicVariable "life_fnc_marketBuy";
publicVariable "life_fnc_marketSell";
publicVariable "life_fnc_marketGetBuyPrice";
publicVariable "life_fnc_marketGetSellPrice";*/
