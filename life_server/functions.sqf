...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 4 :
		{
			...
			_message = format[""!!!ADMIN NACHRICHT: %1"",_msg];
			_admin = format[""Sender: %1"", _from];
			hint parseText format [""<t color='#FF0000'><t size='2'><t align='center'>Admin Message<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>From: <t color='#ffffff'>Death Watch Admins<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
